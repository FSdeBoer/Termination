...
ERO: Frank's proof required both the substition rule and the
invariance rule. The more auxiliary rule we use, the more open ends
or proof obligations are generated. 
...
ERO: Inessantial\,?  The substitution rule appears to be problematic
