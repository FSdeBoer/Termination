...
To keep things simple we assume that all program variables are simple
variables of  type \textbf{integer}.

ERO: AND WHAT ABOUT THE TYPE OF LOGICAL VARIABLES ?
...
ERO: I DON'T UNDERSTAND THE DIFFERENCE HERE. To prove the Equivalence Theorem~\ref{thm:abo}, we also use auxiliary
rule in the Derivability Lemma~\ref{lem:derivability} and then show that
these auxiliary rules are admissible in Lemma~\ref{lem:admissibility}.
Why does this two-step approach not work here as well ?
