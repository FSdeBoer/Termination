...
% We now instantiate part (ii) of Lemma~\ref{lem:equ}.
We show the admissibility of each auxiliary rule in the proof system
with the LOOP rule that used this auxiliary rule according to Lemma~\ref{lem:derivability}. 
