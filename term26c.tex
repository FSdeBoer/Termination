...
TO PERFORM SUCH A RENAMING. *** ERO: ???
...
BY SUCH A STRONGER REQUIREMENT.  *** ERO: ???
...
The proofs are given in Appendix~\ref{sec:proof-derivability}
and Appendix~\ref{sec:proof-admissibility}.
...
\label{sec:proof-derivability}

As explained in Subsection \ref{subsec:structure}, to establish Theorem
\ref{thm:abo} (The proof systems II--V are equivalent.)
it suffices to prove six times the claims of Lemma~\ref{lem:equ} for each pair of rules
\[
...
We first deal with the derivability, instantiating item \emph{(i)} of Lemma~\ref{lem:equ}.
%
% KRAs desire:
...
\section{Admissibility of the Auxiliary Rules}
\label{sec:proof-admissibility}

We now instantiate item \emph{(ii)} of Lemma~\ref{lem:equ}.
